...
//        return isConsumerCallback || isBatchConsumerCallback || isJobHander || (!CollectionUtil.isEmpty(annotationList) && annotationList.isAnnotationPresent(EventProcessor.class));
//    }
//}
